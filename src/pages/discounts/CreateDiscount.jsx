...
import { categories, mockBranches } from '@/data/mockData';
...
const CreateDiscount = () => {
  ...
  const handleSubmit = (e) => {
    ...
    toast({
      ...
      description: 'Yeni endirim uğurla əlavə edildi.',
    });
    navigate('/discounts');
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-foreground">Yeni Endirim</h1>
          <p className="text-muted-foreground mt-1">Yeni endirim kampaniyası yaradın</p>
        </div>
      </div>
